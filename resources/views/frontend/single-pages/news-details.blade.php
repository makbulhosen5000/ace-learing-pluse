                ...
                <section class="main-title-section-wrapper aligncenter"
                    ...
                    <div class="container">
                        ...
                        <div class="breadcrumb"><a href="{{ url('/') }}">Home</a><span
                                class="fas fa-caret-right"></span><span class="current">Blog Details</span></div>
                    </div>
            ...
            <div id="main">
                ...
                <div class="container">
                    ...
                    <section id="primary" class="content-full-width">
                        <article id="post-24570"
                            class="blog-single-entry post-overlay post-24570 post type-post status-publish format-standard has-post-thumbnail hentry category-team tag-art tag-craft">
                            <!-- Featured Image -->
                            <div class="entry-thumb single-preview-img">
                                ...
                                <div class="entry-date">
                                    ...
                                    {{ $news->date }} </div><!-- Entry Date -->

                                {{-- <!-- Entry Comment -->
                                <div class="entry-comments">

                                    <a
                                        href="https://pallikoodam.wpengine.com/reading-practice-for-the-students/#respond"><i
                            ...
                            <div class="entry-body">
                                <div data-elementor-type="wp-post" data-elementor-id="24570"
                                    class="elementor elementor-24570" data-elementor-settings="[]">
                                    <div class="elementor-inner">
                                        <div class="elementor-section-wrap">
                                            
                                            <section
                                                class="elementor-section elementor-top-section elementor-element elementor-element-783c44b elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                data-id="783c44b" data-element_type="section">
                                                <div class="elementor-container elementor-column-gap-default">
                                                    <div class="elementor-row">
                                                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-244a8c4"
                                                            data-id="244a8c4" data-element_type="column">
                                                            <div
                                                                class="elementor-column-wrap elementor-element-populated">
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-8f262ec elementor-widget elementor-widget-text-editor"
                                                                        data-id="8f262ec" data-element_type="widget"
                                                                        data-widget_type="text-editor.default">
                                                                        <div class="elementor-widget-container">
                                                                            <div
                                                                                class="elementor-text-editor elementor-clearfix">
                                                                                <span style="text-transform: uppercase;color:black"> {{ $news->title1 }} :</span>
                                                                            ...
                                                                            <div
                                                                                class="elementor-text-editor elementor-clearfix">
                                                                                <span style="text-transform: uppercase;color:black"> {{ $news->title2 }} :</span>
                                                                            ...
                                                                            <div
                                                                                class="elementor-text-editor elementor-clearfix">
                                                                                <span style="text-transform: uppercase;color:black"> {{ $news->title3 }} :</span>
                            ...
                            {{-- <div class="entry-meta-group">
                                <!-- Entry Tags -->
                                <div class="entry-tags"><span>Tags : </span><a
                                        href="https://pallikoodam.wpengine.com/tag/art/" rel="tag">Art</a>, <a
                                        href="https://pallikoodam.wpengine.com/tag/craft/" rel="tag">Craft</a>
                                </div><!-- Entry Tags -->
                            </div> --}}
                            {{-- <!-- Entry Navigation -->
                            <div class="entry-post-navigation">
                                ...
                                <div class="post-prev-link">
                                    ...
                                    <div style="background-image:url(https://pallikoodam.wpenginepowered.com/wp-content/uploads/2019/09/blog-21.jpg)"
                                        class="prev-post-bgimg"></div>
                                    <a
                                        href="https://pallikoodam.wpengine.com/a-team-dedicated-to-football-matches/"></a>
                                    <div class="nav-title-wrap">
                                        <p>Previous Story</p>
                                        <span class="zmdi zmdi-long-arrow-left zmdi-hc-fw"></span>
                                        <h3><a href="https://pallikoodam.wpengine.com/a-team-dedicated-to-football-matches/"
                                                title="A team dedicated to football matches">
                                                A team dedicated to football matches </a></h3>
                                    </div>
                                ...
                                <div id="comments" class="comments-area">
                                    <div id="respond" class="comment-respond">
                                        <h3 id="reply-title" class="comment-reply-title">Leave a Comment <small><a
                                                    ...
                                                    href="/reading-practice-for-the-students/#respond"
                                                    style="display:none;">Cancel reply</a></small></h3>
                                        <form
                                            action="https://pallikoodam.wpengine.com/wp-comments-post.php?wpe-comment-post=pallikoodam"
                                            ...
                                            <p class="comment-form-url"><label for="url">Website</label> <input
                                                    id="url" name="url" type="url" value=""
                                            ...
                                            <p class="form-submit"><input name="submit" type="submit"
                                                    ...
                                                    type="hidden" name="comment_post_ID" value="24570"
                                                    id="comment_post_ID">
