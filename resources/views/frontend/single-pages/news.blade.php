        ...
        <div class="inner-wrapper">
            ...
            <div id="header-wrapper" class="header-top-relative">
                ...
                <section class="main-title-section-wrapper aligncenter"
                    style="background-image: url('{{ asset('public') }}/frontend/assets/35zdx/wp-content/uploads/2019/09/mmm.jpg'); background-repeat: no-repeat;background-attachment: fixed;background-position: top;">
                    ...
                    <div class="container">
                        ...
                        <div class="breadcrumb"><a href="{{ url('/') }}">Home</a><span
                                class="fas fa-caret-right"></span><span class="current">Blog</span></div>
                    </div>
                            ...
                            <div data-elementor-type="wp-page" data-elementor-id="21919"
                                ...
                                <div class="elementor-inner">
                                    <div class="elementor-section-wrap">
                                        ...
                                        <section
                                            class="elementor-section elementor-top-section elementor-element elementor-element-4a8ba0d elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                            data-id="4a8ba0d" data-element_type="section">
                                            <div class="elementor-container elementor-column-gap-default">
                                                <div class="elementor-row">
                                                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-9b67d3f"
                                                        data-id="9b67d3f" data-element_type="column">
                                                        <div class="elementor-column-wrap elementor-element-populated">
                                                            <div class="elementor-widget-wrap">
                                                                <div class="elementor-element elementor-element-e1b307e elementor-widget elementor-widget-dt-blog-posts"
                                                                    data-id="e1b307e" data-element_type="widget"
                                                                    data-widget_type="dt-blog-posts.default">
                                                                    <div class="elementor-widget-container">
                                                                        <div class="dt-sc-posts-list-wrapper ">
                                                                            <div class="tpl-blog-holder apply-isotope"
                                                                            {{-- style css --}}
                                                                                style="position: relative; height: 1090.47px; margin-bottom:106px">
                                                                                <div class="grid-sizer column dt-sc-one-third dt-sc-post-entry entry-grid-layout dt-sc-boxed-style  dt-sc-default-hover dt-sc-default-overlay alignnone"
                                                                                ...
                                                                                <div class="column dt-sc-one-third dt-sc-post-entry entry-grid-layout dt-sc-boxed-style  dt-sc-default-hover dt-sc-default-overlay alignnone"
                                                                                    style="position: absolute; left: 391.797px; top: 0px;">
                                                                                   
                                                                                    <article id="post-24580"
                                                                                        class="blog-entry format-standard post-24580 post type-post status-publish has-post-thumbnail hentry category-team tag-holiday tag-science">
                                                                                        <!-- Featured Image -->
                                                                                        <div class="entry-thumb"> <a
                                                                                                href="#"
                                                                                                title="Permalink to A team dedicated to football matches">
                                                                                                <img width="570"
                                                                                                    height="356"
                                                                                                    src="{{ asset('public/images/news/'.$news->image) }}"
                                                                                                    class="attachment-pallikoodam-blog-iii-column size-pallikoodam-blog-iii-column wp-post-image"
                                                                                                    alt=""
                                                                                                    >
                                                                                            </a></div>
                                                                                        <!-- Featured Image -->
                                                                                        ...
                                                                                        {{-- <div class="entry-body">
                                                                                            <p>Beautiful branding for
                                                                                                changes by Never Now in
                                                                                                Australia. changes is a
                                                                                                platform for open
                                                                                                discussion in an
                                                                                                inclusive and
                                                                                                collaborative
